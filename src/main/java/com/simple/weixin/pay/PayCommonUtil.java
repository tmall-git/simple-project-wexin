...
public class PayCommonUtil implements Serializable{
	...
	private static String httpsRequest(SSLSocketFactory factory,String requestUrl, String requestMethod, String outputStr) throws Exception {
	 ...
	 public static String httpsRequest(String requestUrl, String requestMethod, String outputStr) {
            try {
				...
				return httpsRequest(ssf,requestUrl,requestMethod,outputStr);
			} catch (Exception e) {
				e.printStackTrace();
			}
	        return null; 
